...
- V1 frozen surface: `docs/testing/v1-closeout.md`
- Existing artifact block scope: `docs/planning/v1d-diff-artifact-renderable-blocks.md`
- Real indbase artifact block adoption: `docs/planning/v1e-real-indbase-renderable-blocks.md`
- Glossary: `CONTEXT.md`
