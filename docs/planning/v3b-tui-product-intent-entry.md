...
- Completed runtime slice: `docs/planning/v3b-runtime-intent-mapper.md`.
- Completed CLI slice for output semantics only: `docs/planning/v3b-agentctl-intent-draft.md`.
- Product entry constraints: `docs/planning/v3a-console-variant-product-entrypoint.md`.
- Main TUI files:
...
3. Add a TUI intent-scope helper.
   - Create a small helper such as `packages/tui/src/variant-intent-scope.ts`.
