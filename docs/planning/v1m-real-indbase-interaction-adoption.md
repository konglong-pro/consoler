...
- Interaction lifecycle: `docs/planning/v1h-interaction-required.md`
- Live CLI interaction client: `docs/planning/v1j-agentctl-run-live-interactions.md`
- Interaction trace/redaction: `docs/planning/v1i-interaction-trace-persistence.md`, `docs/planning/v1l-interaction-response-redaction.md`
- Real ingest command history: `docs/planning/v1a-indbase-ingest-file-side-effect-tracer.md`, `docs/planning/v1e-real-indbase-renderable-blocks.md`
