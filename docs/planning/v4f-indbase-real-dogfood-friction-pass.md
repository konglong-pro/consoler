...
- `docs/testing/v4e-indbase-variant-intent-drafting.md`
...
- Added `docs/testing/v4f-indbase-real-dogfood-friction-pass.md` as the V4f friction register and closeout record.
