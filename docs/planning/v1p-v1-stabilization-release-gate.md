...
- In scope: `docs/testing/v1-release-gate.md`, `scripts/test-v1-release-gate.mjs`, root `package.json`, `.github/workflows/ci.yml`, `AGENTS.md`, and documentation-only planning updates.
...
- V1 release matrix: `docs/testing/v1-release-gate.md`
...
- Do not turn `AGENTS.md` into the V1 acceptance matrix; keep detailed gate content in `docs/testing/v1-release-gate.md`.

## Steps

1. Add the V1 release gate documentation:
   - Create `docs/testing/v1-release-gate.md`.
...
4. Update `AGENTS.md`:
   ...
   - Keep the entry short and point to `docs/testing/v1-release-gate.md` for matrix detail.
