---
doc_type: phase_plan
phase_id: v4d-indbase-dogfood-ux
title: Task execution brief: V4d Indbase Dogfood UX
status: completed
canonical: false
...
- `docs/planning/archive/consoler-v4/v4b-indbase-source-trust-probe.md`
- `docs/planning/archive/consoler-v4/v4c-indbase-probe-stabilization.md`
