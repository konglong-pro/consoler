...
phase_id: v2-release-gate
title: V2 Release Gate
status: frozen
canonical: false
...
| Manual TUI against kept smoke root | Documented in `docs/testing/archive/consoler-v2/v2-artifact-retrieval-closeout.md` | No |
