...
phase_id: v3c-assisted-intent-gate
title: V3c Assisted Intent Gate
status: completed
canonical: false
...
- Product TUI assisted intent remains covered by `pnpm test:v3c-tui-assisted-intent-gate` and `docs/testing/archive/consoler-v3/v3c-tui-assisted-intent-gate.md`.
